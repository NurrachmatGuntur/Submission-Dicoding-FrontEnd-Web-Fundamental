...
const displayMovieList = (movies) => {
  ...
  for (let idx = 0; idx < movies.length; idx++) {
    ...
    movieListItem.innerHTML = `
        <div class="search-item-thumbnail"></div>
...
// ini costum element (belum diubah custome elementnya)
const displayMovieDetails = (details) => {
  const displayDetailElement = document.createElement("display-detail");
  displayDetailElement.displayMovieDetails = details;
  resultGrid.appendChild(displayDetailElement);
